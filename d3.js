...
(function(global, factory) {
  ...
  var cross = function(a, b, f) {
    ...
    for (ia = ic = 0; ia < na; ++ia)
      for (va = a[ia], ib = 0; ib < nb; ++ib, ++ic) c[ic] = f(va, b[ib]);
    return c;
  };
  ...
  var sum = function(array, f) {
    ...
    if (f == null) {
      while (++i < n)
        if (a = +array[i]) s += a; // Note: zero and null are equivalent.
    } else {
      while (++i < n)
  ...
  var identity$5 = function() {
    var k = 1,
      ...
      sx = 1,
      sy = 1,
      transform = identity$4, // scale, translate and reflect
      x0 = null,
      y0, x1, y1, clip = identity$4, // clip extent
      cache,
      cacheStream,
      projection;
